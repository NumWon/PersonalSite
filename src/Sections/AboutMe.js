	...
	return (
		<section id='about' className="about-section">
			...
			<div className="about-container">
				...
				I am a motivated and enthusiastic software developer with a strong work ethic, a passion for tackling complex challenges, and a commitment to learning anywhere and everywhere I am able to. I love seeking new business opportunities, working on large-scale projects, and meeting interesting people.<br/><br/>My skills and motivation have helped me gain a lot of success in my short yet continuing career.
				</p>
			</div>
		</section>
	);
